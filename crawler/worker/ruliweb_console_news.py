...
class RuliwebConsoleNews(BaseSite):
    ...
    def crawler(self):
        log = logger.getChild('RuliwebConsoleNews.crawler')
        for page in range(1, self.pageMax + 1, 1):
            host = 'http://bbs.ruliweb.com/news/board/1001'
    ...
    def do(self):
        log = logger.getChild('RuliwebConsoleNews.do')
